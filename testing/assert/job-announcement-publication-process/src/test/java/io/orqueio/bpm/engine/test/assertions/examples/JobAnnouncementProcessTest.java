 ...
 */
package io.orqueio.bpm.engine.test.assertions.examples;

import io.orqueio.bpm.engine.runtime.ProcessInstance;
import io.orqueio.bpm.engine.test.Deployment;
import io.orqueio.bpm.engine.test.ProcessEngineRule;
import io.orqueio.bpm.engine.test.assertions.examples.jobannouncement.JobAnnouncement;
import io.orqueio.bpm.engine.test.assertions.examples.jobannouncement.JobAnnouncementService;
import io.orqueio.bpm.engine.test.mock.Mocks;
...
import static io.orqueio.bpm.engine.test.assertions.bpmn.BpmnAwareTests.findId;
...
public class JobAnnouncementProcessTest {
  ...
  @Deployment(resources = {
    "orqueio-testing-job-announcement.bpmn",
    "orqueio-testing-job-announcement-publication.bpmn"
  })
  ...
  @Test
  @Deployment(resources = { "orqueio-testing-job-announcement.bpmn", "orqueio-testing-job-announcement-publication.bpmn" })
  ...
  private ProcessInstance startProcess() {
    return runtimeService().startProcessInstanceByKey(
      "orqueio-testing-job-announcement",
