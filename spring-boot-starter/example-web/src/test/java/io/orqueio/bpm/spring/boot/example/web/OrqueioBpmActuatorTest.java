 ...
 */
package io.orqueio.bpm.spring.boot.example.web;
...
@DirtiesContext
public class OrqueioBpmActuatorTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(OrqueioBpmActuatorTest.class);
