# Register Your Process Engine in JUnit 5 and Orqueio Platform Assert

This examples shows how to create a process engine in your test class without a configuration file and register it for your test runs using the [JUnit 5 extension][junit5] and [Orqueio Platform Assert][assert].
...
* (1) The test class that
    ...
    * registers the process engine for the Orqueio Platform Assert library
